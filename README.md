...
| --- | --- |
| DB2App-1_war.ear | Application binary ear, or war or jar file |
...
3. Create a OpenShift pipeline and pipeline resources for building and deploying this application
   ...
   - The branch for the git repo is set to `main` by default, if you wish to update that please do so in the `03-pipeline-run.yaml` file.
